...
## 2. Organigramme Complet (Serveur)
...
```
                         ...
                         └─────────────────────┬─────────────────────┘
                                    ...
                                    └──────────┬──────────┘
                                               │
                         ┌─────────────────────┴─────────────────────┐
                         │    BOUCLE DE JEU (tant que !partie_finie) │
                         └─────────────────────┬─────────────────────┘
                                               │
                                               ▼
                              ┌─────────────────────────────────┐
                              │ Le joueur actuel est éliminé ?  │
                              │   (clientX_actif == 0)          │
                              └────────────────┬────────────────┘
                                               │
                                    ┌──────────┴──────────┐
                         ...
                         └────────┬─────────┘             │
                                  ...
                                  │ ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐
                                  │ │  WIN   │ │   OK   │ │  LOSE  │ │  NOK   │
                                  │ │partie_ │ │info=   │ │clientX_│ │info=   │
                                  │ │finie=1 │ │"INFO   │ │actif=0 │ │"INFO   │
                                  │ │info=   │ │ OK"    │ │info=   │ │ NOK"   │
                                  │ │"OPPO-  │ └───┬────┘ │"INFO   │ └───┬────┘
                                  │ │NENT_WIN"│    │      │ LOSE"  │     │
                                  │ └───┬────┘    │      └───┬────┘     │
                                  ...
                                  └─────┴─────────┴──────────┴──────────┘
                                              ...
                                              ▼
                              ┌─────────────────────────────────┐
                              │  Envoyer reponse au joueur actif│
                              └────────────────┬────────────────┘
                                               │
                                               ▼
                              ┌─────────────────────────────────┐
                         ...
                         └────────┬─────────┘             │
                                  ...
                                  └───────────┬───────────┘
                                              ...
                                              ▼
                              ┌─────────────────────────────────┐
                              │  Si LOSE: marquer joueur actif  │
                              │  comme éliminé, changer tour    │
                              │  Si les 2 éliminés: partie_finie│
                              └────────────────┬────────────────┘
                                               │
                                               ▼
                              ┌─────────────────────────────────┐
                         ...
                         │ Retour début     │                    │
                         │ boucle parties   │◄───────────────────┘
                         │ (nouvelle partie)│     (continuer boucle jeu)
                         └──────────────────┘
```
